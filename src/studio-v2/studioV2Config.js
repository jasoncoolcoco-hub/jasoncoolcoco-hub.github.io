...
export const STUDIO_V2_MATERIAL_TUNING = {
  ...
  StudioV2IslandPainted: { category: 'PAINTED KITCHEN ISLAND FRONT', color: '#252826', metalness: 0.02, roughness: 0.64, envMapIntensity: 0.72 },
  ...
  StudioV2KitchenPainted: { category: 'PAINTED KITCHEN CABINETS', color: '#181a19', metalness: 0.04, roughness: 0.6, envMapIntensity: 0.76 },
  StudioV2KitchenMetal: { category: 'SINK / FAUCET', metalness: 0.94, roughness: 0.25, envMapIntensity: 1.28 },
  StudioV2KitchenHandle: { category: 'CABINET HANDLES', metalness: 0.88, roughness: 0.3, envMapIntensity: 1.16 },
  StudioV2KitchenAppliance: { category: 'OVEN / STOVE METAL', metalness: 0.78, roughness: 0.32, envMapIntensity: 1.14 },
  StudioV2KitchenGlass: { category: 'OVEN GLASS', metalness: 0, roughness: 0.22, envMapIntensity: 1 },
  'Material.009': { category: 'REFRIGERATOR / COATED APPLIANCE', metalness: 0.08, roughness: 0.5, envMapIntensity: 0.82 },
